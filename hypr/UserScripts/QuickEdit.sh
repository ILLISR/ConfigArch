...
menu(){
  ...
  printf "11. edit nvim config\n"
  printf "12. edit tmux config\n"
  printf "13. edit zshrc config\n"
  printf "14. edit UserScripts\n"
}
...
main() {
    ...
    case $choice in
        ...
        10)
            ...
            ;;
        11)
            $tty $editor "$terminalConfigs/nvim"
            ;;
        12)
            $tty $editor "$terminalConfigs/tmux"
            ;;
        13)
            $tty $editor "$HOME/.zshrc"
            ;;
        14)
            $tty $editor "$HOME/.config/hypr/UserScripts"
            ;;
        11)
            $tty $editor "$terminalConfigs/nvim"
            ;;
