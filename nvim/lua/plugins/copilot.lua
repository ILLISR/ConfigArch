...
return {
  ...
  -- Which-key plugin configuration
  {
    ...
    opts = {
      spec = {
        { "<leader>i", group = "ai" }, -- Define a group for AI-related commands
  ...
  -- Copilot Chat plugin configuration
  {
    ...
    opts = {
      ...
      chat_autocomplete = true, -- Enable chat chat_autocomplete
      mappings = {
        ...
        show_info = { normal = "gmp" }, -- Keybinding to show system prompt
        show_context = { normal = "gms" }, -- Keybinding to show user selection
    ...
    keys = {
      ...
      { "<leader>iv", ":CopilotChatVisual", mode = "x", desc = "CopilotChat - Open in vertical split" },
      { "<leader>ix", ":CopilotChatInline<cr>", mode = "x", desc = "CopilotChat - Inline chat" },
      {
        "<leader>ii",
        function()
      ...
      { "<leader>im", "<cmd>CopilotChatCommit<cr>", desc = "CopilotChat - Generate commit message for all changes" },
      {
        "<leader>iM",
